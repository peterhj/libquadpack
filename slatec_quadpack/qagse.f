*DECK QAGSE
      SUBROUTINE QAGSE (F, UDATA, A, B, EPSABS, EPSREL, LIMIT, RESULT,
...
C
      ...
      OFLOW = R1MACH(2)
      IERRO = 0
      CALL QK21(F,UDATA,A,B,RESULT,ABSERR,DEFABS,RESABS)
C
C           TEST ON ACCURACY.
C
      DRES = ABS(RESULT)
...
C
        ...
        B2 = BLIST(MAXERR)
        ERLAST = ERRMAX
        CALL QK21(F,UDATA,A1,B1,AREA1,ERROR1,RESABS,DEFAB1)
        CALL QK21(F,UDATA,A2,B2,AREA2,ERROR2,RESABS,DEFAB2)
C
