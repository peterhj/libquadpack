*DECK DQAGSE
     ...
     +   NEVAL, IER, ALIST, BLIST, RLIST, ELIST, IORD, LAST, UDATA)
...
C
      ...
      OFLOW = D1MACH(2)
      IERRO = 0
      CALL DQK21(F,A,B,RESULT,ABSERR,DEFABS,RESABS,UDATA)
C
C           TEST ON ACCURACY.
C
      DRES = ABS(RESULT)
...
C
        ...
        B2 = BLIST(MAXERR)
        ERLAST = ERRMAX
        CALL DQK21(F,A1,B1,AREA1,ERROR1,RESABS,DEFAB1,UDATA)
        CALL DQK21(F,A2,B2,AREA2,ERROR2,RESABS,DEFAB2,UDATA)
C
